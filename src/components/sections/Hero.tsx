...
export function Hero() {
  ...
  return (
    ...
    >
      ...
      <ScrollReveal direction="down" duration={1000} delay={0} className="w-full text-center z-0 select-none pointer-events-none mt-4 md:mt-8">
      ...
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[280px] h-[340px] sm:w-[350px] sm:h-[420px] md:w-[460px] md:h-[550px] lg:w-[500px] lg:h-[600px] z-10 pointer-events-none">
        <div className="relative w-full h-full">
          ...
          <ScrollReveal
            ...
            duration={500}
            delay={700}
            className="absolute top-[24%] -left-[5%] md:-left-[12%] lg:-left-[16%] xl:-left-[20%] z-20 pointer-events-auto"
          >
          ...
          <ScrollReveal
            ...
            duration={500}
            delay={850}
            className="absolute bottom-[36%] -left-[8%] md:-left-[16%] lg:-left-[20%] xl:-left-[24%] z-20 pointer-events-auto"
          >
            <TiltCard maxTilt={15} scale={1.05} enableGlare={true} className="rounded-2xl">
              <div className="flex items-center gap-3 px-4 py-3 bg-white border border-border-gray shadow-md rounded-2xl w-[170px] sm:w-[190px] transform-gpu [transform-style:preserve-3d]">
          ...
          <ScrollReveal
            ...
            duration={500}
            delay={1000}
            className="absolute bottom-[15%] -left-[3%] md:-left-[8%] lg:-left-[10%] xl:-left-[12%] z-20 pointer-events-auto"
          >
            <TiltCard maxTilt={15} scale={1.05} enableGlare={true} className="rounded-2xl">
              <div className="flex items-center gap-3 px-4 py-3 bg-white border border-border-gray shadow-md rounded-2xl w-[170px] sm:w-[190px] transform-gpu [transform-style:preserve-3d]">
          ...
          <ScrollReveal
            ...
            duration={500}
            delay={1150}
            className="absolute top-[28%] -right-[5%] md:-right-[12%] lg:-right-[16%] xl:-right-[20%] z-20 pointer-events-auto"
          >
            <TiltCard maxTilt={15} scale={1.05} enableGlare={true} className="rounded-2xl">
              <div className="flex items-center gap-3 px-4 py-3 bg-white border border-border-gray shadow-md rounded-2xl w-[170px] sm:w-[190px] transform-gpu [transform-style:preserve-3d]">
          ...
          <ScrollReveal
            ...
            duration={500}
            delay={1300}
            className="absolute bottom-[28%] -right-[8%] md:-right-[16%] lg:-right-[20%] xl:-right-[24%] z-20 pointer-events-auto"
          >
            <TiltCard maxTilt={15} scale={1.05} enableGlare={true} className="rounded-2xl">
              <div className="flex items-center gap-3 px-4 py-3 bg-white border border-border-gray shadow-md rounded-2xl w-[170px] sm:w-[190px] transform-gpu [transform-style:preserve-3d]">
